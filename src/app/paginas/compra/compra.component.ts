...
// Metodo que se ejecuta al inicilizar el componente
ngOnInit(): void {
...
const doc = new jsPDF(); // Crea instacia de jsPDF
...
imprimirPDF():void{
  // Obtiene la refencia al elemento iframe del DOM mediante su ID 'pdfFrame'
  ...
  if (iframe && iframe.contentWindow){
    // Le da foco al contendido del iframe para asegurarse que la ventana correcta esta activa para imprimir
